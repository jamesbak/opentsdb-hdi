...
wget "https://github.com/jamesbak/opentsdb-hdi/files/516851/OPENTSDB.tar.gz" -O /tmp/OPENTSDB.tar.gz
...
if [ ! -z "$proxy_domain_suffix" ]; then
    echo "$(date +%T) Building IFrame View to point to edge node at address: "    
fi
